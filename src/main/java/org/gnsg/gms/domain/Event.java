...
public class Event implements Serializable {
    ...
    public Event family(String family) {
        this.family = family;
        return this;
    }
    ...
    public Event withLangar(Boolean withLangar) {
    ...
    public Event langarMenu(LANGARMENU langarMenu) {
    ...
    public Event langarTime(Instant langarTime) {
    ...
    public Event dueAmt(BigDecimal dueAmt) {
        this.dueAmt = dueAmt;
        return this;
    }
    ...
    public Event paidAmt(BigDecimal paidAmt) {
    ...
    public Event balAmt(BigDecimal balAmt) {
        this.balAmt = balAmt;
        return this;
    }
    ...
    public Event recieptNumber(Long recieptNumber) {
    ...
    public Event bookingDate(Instant bookingDate) {
    ...
    public Event employee(Employee employee) {
